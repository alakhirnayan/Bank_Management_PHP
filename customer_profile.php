        ...
        <div class="flex-container">
            <div class=container>
                <label>Bank Branch :
                    <label id="info_label">
                        <?php
                            if ($branch == "dhaka") {echo "Dhaka";}
                            elseif ($branch == "khulna") {echo "Khulna";}
                            elseif ($branch == "Sylhet") {echo "Sylhet";}
                            elseif ($branch == "chittagong") {echo "Chittagong";}
                            elseif ($branch == "rajshahi") {echo "Rajshahi";}
                            elseif ($branch == "dinajpur") {echo "Dinajpur";}
                            elseif ($branch == "comilla") {echo "Comilla";}
                        ?>
                    </label>
                </label>
            </div>
