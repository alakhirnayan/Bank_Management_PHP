...
<body>
    <form class="add_customer_form" action="customer_customer_add_action.php" method="post">
        ...
        <div class="flex-container">
            ...
            <div  class=container>
                <select name="branch">
                    <option value="delhi">Dhaka</option>
                    <option value="delhi">Khulna</option>
                    <option value="newyork">Sylhet</option>
                    <option value="paris">Chittagong</option>
                    <option value="riyadh">Comilla</option>
                    <option value="moscow">Rajshahi</option>
                    <option value="moscow">Dinajpur</option>
                    <option value="moscow">Noakhali</option>
                </select>
            </div>
        </div>
        ...
        <div class="flex-container">
            ...
            <div class="container">
            <a href="./home.php" class="button">Back to Login</a>
        </div>
        </div>
