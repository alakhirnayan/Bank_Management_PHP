...
$sql7 = "INSERT INTO loan".$id." VALUES(
            NULL,
            NOW(),
    ...
    <div class="flex-container">
        ...
        <div class="flex-item">
            ...
            if (($conn->query($sql6) === TRUE)) { ?>
                <p id="info"><?php echo "Loan created successfully !\n"; ?></p>
            <?php
            } else { ?>
                <p id="info"><?php
                echo "Error: " . $sql6 . "<br>" . $conn->error . "<br>"; ?></p>
            <?php } ?>
        </div>
        ...
        <div class="flex-item">
            ...
            if (($conn->query($sql7) === TRUE)) { ?>
                <p id="info"><?php echo "Loan updated successfully !\n"; ?></p>
            <?php
            } else { ?>
                <p id="info"><?php
                echo "Error: " . $sql7 . "<br>" . $conn->error . "<br>"; ?></p>
            <?php } ?>
        </div>
